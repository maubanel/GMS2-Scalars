...
draw_text(room_width * .5, 32, "Ease In/Out Quadric - Room 14");
draw_set_font(fnt_reg);
draw_set_color(c_white)
draw_text(room_width * .5, 64, "Pass scalar val to function and return val < .5 ? 2 * val * val : -1 + (4 - 2 * val) * val");
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Fade in quadric ease-in-out over 4 seconds";
draw_set_font(fnt_code_small);
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Scale in quadric ease-in-out over 4 seconds";
draw_set_font(fnt_code_small);
draw_text(code_x, code_y, line_1);
code_y += line_height;
s_wid = 0;
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Lerp to destination with quadric ease-in-out over 4 seconds";
draw_set_font(fnt_code_small);
draw_text(code_x, code_y, line_1);
code_y += line_height;
s_wid = 0;

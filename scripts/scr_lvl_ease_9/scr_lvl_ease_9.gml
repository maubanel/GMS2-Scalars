...
draw_text(room_width * .5, 32, "Ease In Quint - Room 9");
draw_set_font(fnt_reg);
draw_set_color(c_white)
draw_text(room_width * .5, 64, "Pass scalar val to function and return val * val * val * val * val");

/// Titles for Eases
draw_set_font(fnt_small);
draw_text(288, 208, "Linear");
draw_text(354, 208, "Ease-In");
draw_text(354, 226, "1");
draw_text(418, 208, "Ease-In");
draw_text(418, 226, "2");
draw_text(480, 208, "Ease-In");
draw_text(480, 226, "3");
draw_text(546, 208, "Ease-In");
draw_text(546, 226, "4");
...
y_pos += offset;
draw_line(l_margin_x, y_pos, second_column_x, y_pos);
draw_text(l_margin_x + text_offset, y_pos - offset * .5, "cubic ease-in 2");

y_pos += offset;
draw_line(l_margin_x, y_pos, second_column_x, y_pos);
draw_text(l_margin_x + text_offset, y_pos - offset * .5, "quart ease-in 3");

y_pos += offset;
draw_line(l_margin_x, y_pos, second_column_x, y_pos);
draw_text(l_margin_x + text_offset, y_pos - offset * .5, "quint ease-in 4");
...
var ease_in_2 = ease_scalar(eas_in, linear, 2);
var ease_in_3 = ease_scalar(eas_in, linear, 3);
var ease_in_4 = ease_scalar(eas_in, linear, 4);
...
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 2.5) , ease_in_2);
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 3.5) , ease_in_3);
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 4.5) , ease_in_4);
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Fade with quintic ease over 1.5 seconds";
draw_set_font(fnt_code_small);
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Scale with quintic ease over 1.5 seconds";
draw_set_font(fnt_code_small);
draw_text(code_x, code_y, line_1);
code_y += line_height;
s_wid = 0;
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Lerp to destination with quintic ease over 1.5 seconds";
draw_set_font(fnt_code_small);
draw_text(code_x, code_y, line_1);
code_y += line_height;
s_wid = 0;

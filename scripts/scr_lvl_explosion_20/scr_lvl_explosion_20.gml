...
draw_text(room_width * .5, 32, "Use of Scalar Example 1 - Room 20");
draw_set_font(fnt_reg);
draw_set_color(c_white)
draw_text(room_width * .5, 64, @"Explosion to land triangles within circumference of two outer circles
Use ease out to apply instant force and simulate friction with the ease");

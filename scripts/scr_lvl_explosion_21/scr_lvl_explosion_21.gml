...
draw_text(room_width * .5, 32, "Use of Scalar Example 1 - Room 21");
draw_set_font(fnt_reg);
draw_set_color(c_white)
draw_text(room_width * .5, 64, @"Explosion to land triangles within circumference of two outer circles
Add a random start delay and random speed to make it look more natural");
...
draw_set_font(fnt_code_small);
line_1 = "// Add randomness to speed of scalar and timing";

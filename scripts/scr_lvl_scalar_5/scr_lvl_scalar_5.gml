...
draw_text(room_width * .5, 32, "Fade, Scale & LERP Bounce Repeat Delay - Room 5");
draw_set_font(fnt_reg);
draw_set_color(c_white)
draw_text(room_width * .5, 64, "Scalar repeats value lerp(), image_index, xscale and yscale loop 0 to 1 and back every 1 second with a 2 second delay");
...
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * .5) , obj_room_5_fade_up.image_alpha);
...
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * .5) , obj_room_5_scale_up.image_xscale);

draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 1.5) , obj_room_5_scale_up.image_yscale);
...
draw_set_halign(fa_center);
draw_text(((second_column_x - l_margin_x) * .5) + l_margin_x, y_pos - offset * .5, "lerp (" + string(obj_room_5_lerp.ystart) + ", " + string(obj_room_5_lerp.yend) + ", " + string(obj_room_5_lerp.ind) + ");");
...
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * .5) , obj_room_5_lerp.y);

draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 1.5) , obj_room_5_lerp.ystart);

draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 2.5) , obj_room_5_lerp.yend);
...
// var new_alpha = update_scalar(0, 1, scl_bounce_repeat_delay, 2);
// image_alpha = new_alpha;

draw_set_color(c_green);
code_y += line_height;
line_1 = "// Fade in then out image_alpha of object every 2 seconds";
draw_set_font(fnt_code_small);
...
s_wid += string_width(line_1);
draw_set_color(c_internal_var);
line_1 = "scl_bounce_repeat_delay";
draw_text(code_x + s_wid, code_y, line_1);
s_wid += string_width(line_1);
draw_set_color(c_white);
line_1 = ",";
...
// var new_scale = update_scalar(0, 1, scl_bounce_repeat_delay, 2);
// image_xscale = new_scale;
// image_yscale = new_scale;

draw_set_color(c_green);
code_y += line_height;
line_1 = "// Scale up then down object every 2 seconds";
draw_set_font(fnt_code_small);
draw_text(code_x, code_y, line_1);
code_y += line_height;
s_wid = 0;
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Lerp to target and back every 2 seconds";
draw_set_font(fnt_code_small);
draw_text(code_x, code_y, line_1);
code_y += line_height;
s_wid = 0;

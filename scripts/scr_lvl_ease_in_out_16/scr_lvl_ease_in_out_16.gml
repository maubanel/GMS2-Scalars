...
draw_text(room_width * .5, 32, "Ease In/Out Quart - Room 16");
draw_set_font(fnt_reg);
draw_set_color(c_white)
draw_text(room_width * .5, 64, "Pass scalar val to function and return val < .5 ? 8 * val * val * val * val : 1 - 8 * (--val) * val * val * val");
...
draw_text(418, 226, "In-Out2");
draw_text(480, 208, "Ease");
draw_text(480, 226, "In-Out3");
...
var linear = update_scalar(0, 2, scl_once);
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Fade with quartic ease-in-out over 2 seconds";
draw_set_font(fnt_code_small);
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Scale with quartic ease-in-out over 2 seconds";
draw_set_font(fnt_code_small);
draw_text(code_x, code_y, line_1);
code_y += line_height;
s_wid = 0;
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Lerp to destination with quartic ease-in-out over 2 seconds";
draw_set_font(fnt_code_small);
draw_text(code_x, code_y, line_1);
code_y += line_height;
s_wid = 0;

...
draw_text(room_width * .5, 32, "Ease Out Cubic - Room 11");
draw_set_font(fnt_reg);
draw_set_color(c_white)
draw_text(room_width * .5, 64, "Pass scalar val to function and return (--val) * val * val + 1");


/// Titles for Eases
draw_set_font(fnt_small);
draw_text(288, 208, "Linear");
draw_text(381, 208, "Ease-Out 1");
draw_text(481, 206, "Ease-Out 2");
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Fade with cubic ease-out over 3 seconds";
draw_set_font(fnt_code_small);
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Scale with cubic ease-out over 3 seconds";
draw_set_font(fnt_code_small);
draw_text(code_x, code_y, line_1);
code_y += line_height;
s_wid = 0;
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Lerp to destination with cubic ease-out over 3 seconds";
draw_set_font(fnt_code_small);
draw_text(code_x, code_y, line_1);
code_y += line_height;
s_wid = 0;

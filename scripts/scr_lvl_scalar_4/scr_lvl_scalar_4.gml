...
draw_text(room_width * .5, 32, "Fade, Scale & LERP Bounce Repeat - Room 4");
draw_set_font(fnt_reg);
draw_set_color(c_white)
draw_text(room_width * .5, 64, "Scalar changes value amount of lerp(), image_index, xscale and yscale loop 0 to 1 and back every 2 seconds");
...
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * .5) , obj_room_4_fade_up.image_alpha);
...
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * .5) , obj_room_4_scale_up.image_xscale);

draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 1.5) , obj_room_4_scale_up.image_yscale);
...
draw_set_halign(fa_center);
draw_text(((second_column_x - l_margin_x) * .5) + l_margin_x, y_pos - offset * .5, "lerp (" + string(obj_room_4_lerp.ystart) + ", " + string(obj_room_4_lerp.yend) + ", " + string(obj_room_4_lerp.ind) + ");");
...
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * .5) , obj_room_4_lerp.y);

draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 1.5) , obj_room_4_lerp.ystart);

draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 2.5) , obj_room_4_lerp.yend);
...
// var new_scale = update_scalar(0, 3, scl_bounce_repeat);
...
//var new_y_pos =  update_scalar(0, 3, scl_bounce_repeat);

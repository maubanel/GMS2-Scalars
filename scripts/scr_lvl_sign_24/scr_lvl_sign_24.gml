...
draw_text(room_width * .5, 32, "Use of Scalar Example 2 - Room 24");
...
Use ease to cheat the illusion of 3-D");
...
//y_pos += offset;
draw_line(l_margin_x, y_pos, second_column_x, y_pos);
draw_text(l_margin_x + text_offset, y_pos - offset * .5, "ease value");
...
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 1.5) , obj_welcome.new_scale_2);
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 2.5) , obj_welcome.image_xscale);
...
draw_set_font(fnt_code);
//new_scale = ease_scalar(ease_type, new_scale, ease_amount);
code_y += line_height;
s_wid = 0;
draw_set_color(c_local_var);
line_1 = "new_scale ";
...
s_wid += string_width(line_1);
draw_set_color(c_internal_var);
line_1 = obj_welcome.ease_amount;
draw_text (code_x + s_wid, code_y, line_1);
s_wid += string_width(line_1);
...
draw_text(672, 479, "Ease Type: " + string(line_1));

draw_text(672, 608, "Ease Amount: " + string(obj_welcome.ease_amount));

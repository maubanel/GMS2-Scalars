...
draw_text(room_width * .5, 32, "Ease In/Out Quint - Room 17");
draw_set_font(fnt_reg);
draw_set_color(c_white)
draw_text(room_width * .5, 64, "Pass scalar val to function and return val < .5 ? 16 * val * val * val * val * val : 1 + 16 * (--val) * val * val * val * val");

/// Titles for Eases
draw_set_font(fnt_small);
draw_text(288, 208, "Linear");
draw_text(354, 208, "Ease");
draw_text(354, 226, "In-Out 1");
draw_text(418, 208, "Ease");
draw_text(418, 226, "In-Out 2");
draw_text(480, 208, "Ease");
draw_text(480, 226, "In-Out 3");
draw_text(546, 208, "Ease");
draw_text(546, 226, "In-Out 4");
...
y_pos += offset;
draw_line(l_margin_x, y_pos, second_column_x, y_pos);
draw_text(l_margin_x + text_offset, y_pos - offset * .5, "quadric ease-in-out 1");

y_pos += offset;
draw_line(l_margin_x, y_pos, second_column_x, y_pos);
draw_text(l_margin_x + text_offset, y_pos - offset * .5, "cubic ease-in-out 2");

y_pos += offset;
draw_line(l_margin_x, y_pos, second_column_x, y_pos);
draw_text(l_margin_x + text_offset, y_pos - offset * .5, "quart ease-in-out 3");

y_pos += offset;
draw_line(l_margin_x, y_pos, second_column_x, y_pos);
draw_text(l_margin_x + text_offset, y_pos - offset * .5, "quint ease-in-out 4");
...
var linear = update_scalar(0, 1.5, scl_once);
var ease_in_out_1 = ease_scalar(eas_in_out, linear, 1);
var ease_in_out_2 = ease_scalar(eas_in_out, linear, 2);
var ease_in_out_3 = ease_scalar(eas_in_out, linear, 3);
var ease_in_out_4 = ease_scalar(eas_in_out, linear, 4);
...
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 1.5) , ease_in_out_1);
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 2.5) , ease_in_out_2);
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 3.5) , ease_in_out_3);
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 4.5) , ease_in_out_4);
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Fade with quintic ease-in-out over 1.5 seconds";
draw_set_font(fnt_code_small);
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Scale with quintic ease-in-out over 1.5 seconds";
draw_set_font(fnt_code_small);
draw_text(code_x, code_y, line_1);
code_y += line_height;
s_wid = 0;
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Lerp to destination with quintic ease-in-out over 1.5 seconds";
draw_set_font(fnt_code_small);
draw_text(code_x, code_y, line_1);
code_y += line_height;
s_wid = 0;

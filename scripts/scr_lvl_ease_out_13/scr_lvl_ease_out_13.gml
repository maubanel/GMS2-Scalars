...
draw_text(room_width * .5, 32, "Ease Out Quint - Room 13");
draw_set_font(fnt_reg);
draw_set_color(c_white)
draw_text(room_width * .5, 64, "Pass scalar val to function and return 1 + (--val) * val * val * val * val");

/// Titles for Eases
draw_set_font(fnt_small);
draw_text(288, 208, "Linear");
draw_text(354, 208, "Ease-Out");
draw_text(354, 226, "1");
draw_text(418, 208, "Ease-Out");
draw_text(418, 226, "2");
draw_text(480, 208, "Ease-Out");
draw_text(480, 226, "3");
draw_text(546, 208, "Ease-Out");
draw_text(546, 226, "4");
...
y_pos += offset;
draw_line(l_margin_x, y_pos, second_column_x, y_pos);
draw_text(l_margin_x + text_offset, y_pos - offset * .5, "quadric ease-out 1");

y_pos += offset;
draw_line(l_margin_x, y_pos, second_column_x, y_pos);
draw_text(l_margin_x + text_offset, y_pos - offset * .5, "cubic ease-out 2");

y_pos += offset;
draw_line(l_margin_x, y_pos, second_column_x, y_pos);
draw_text(l_margin_x + text_offset, y_pos - offset * .5, "quart ease-out 3");

y_pos += offset;
draw_line(l_margin_x, y_pos, second_column_x, y_pos);
draw_text(l_margin_x + text_offset, y_pos - offset * .5, "quint ease-out 4");
...
var ease_out_1 = ease_scalar(eas_out, linear, 1);
var ease_out_2 = ease_scalar(eas_out, linear, 2);
var ease_out_3 = ease_scalar(eas_out, linear, 3);
var ease_out_4 = ease_scalar(eas_out, linear, 4);
...
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 1.5) , ease_out_1);
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 2.5) , ease_out_2);
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 3.5) , ease_out_3);
draw_text(((second_column_x - first_column_x) * .5) + first_column_x, initial_y_pos + (offset * 4.5) , ease_out_4);
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Fade with quintic ease-out over 1.5 seconds";
draw_set_font(fnt_code_small);
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Scale with quintic ease-out over 1.5 seconds";
draw_set_font(fnt_code_small);
draw_text(code_x, code_y, line_1);
code_y += line_height;
s_wid = 0;
...
draw_set_color(c_green);
code_y += line_height;
line_1 = "// Lerp to destination with quintic ease-out over 1.5 seconds";
draw_set_font(fnt_code_small);
draw_text(code_x, code_y, line_1);
code_y += line_height;
s_wid = 0;
